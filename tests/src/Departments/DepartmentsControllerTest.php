...
use HR\Departments\{ DepartmentsDto, DepartmentsModel, DepartmentsController };
...
class DepartmentsControllerTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        $this->input = [
            "department_id" => 7859,
            "department_name" => "fish",
            "location_id" => 1528,
        ];
        $this->dto = new DepartmentsDto($this->input);
        $this->model = new DepartmentsModel($this->dto);
        $this->service = $this->createMock("HR\Departments\IDepartmentsService");
